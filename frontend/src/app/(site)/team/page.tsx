      ...
      <section className="bg-maroon px-6 py-16 text-center lg:px-20 lg:py-20">
        <div className="mx-auto flex max-w-[1280px] flex-col items-center gap-6">
          ...
          <p className="max-w-[800px] text-base text-white/90 sm:text-lg">
            Meet the dedicated people working together under the divine grace of Baba Shyam to
            guide, grow, and strengthen our global socio-spiritual mission.
          </p>
        </div>
      </section>
          ...
          <div className="flex flex-col items-start gap-8 rounded-2xl border border-[rgba(212,175,55,0.25)] bg-cream p-8 lg:flex-row lg:items-center">
            <div className="flex flex-1 flex-col items-start gap-4">
              ...
              <p className="text-[15px] leading-6 text-[#595656]">
                Our executive operations, event coordinators, and day-to-day administrative
                personnel ensure that local darshans, matrimonial connections, temple list
                updates, and medical sevas are handled seamlessly.
              </p>
              <Link
        ...
        <div className="mx-auto grid max-w-[1280px] gap-6 lg:grid-cols-2">
          <div className="flex flex-col items-start gap-5 rounded-2xl border border-[rgba(212,175,55,0.25)] bg-white p-7">
            ...
            <p className="text-sm leading-[22px] text-[#595656]">
              Sages, retired jurists, and highly experienced community elders who keep our
              policies anchored in ethics and dharma.
            </p>
            <Link
          ...
          <div className="flex flex-col items-start gap-5 rounded-2xl border border-[rgba(212,175,55,0.25)] bg-white p-7">
            ...
            <p className="text-sm leading-[22px] text-[#595656]">
              Regional teams managing local chapters, temple registries, bhajan sandhya bookings,
              and social support grids across 15+ Indian states.
            </p>
            <Link
