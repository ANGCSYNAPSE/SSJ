...
import { type Person, type StateDetail } from "@/lib/stateTeams";
...
export default function StateDetailClient({ detail }: { detail: StateDetail }) {
    ...
    <>
      ...
      <div className="bg-white px-6 pb-2 pt-6 lg:px-20">
        <div className="mx-auto flex max-w-[1280px] items-center gap-2 text-[13px]">
          ...
          <span className="text-[#9ca3af]">/</span>
          <span className="font-semibold text-primary">{stateName}</span>
        </div>
      </div>
