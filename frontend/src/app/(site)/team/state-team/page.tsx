      ...
      <section className="bg-maroon px-6 py-16 text-center lg:px-20 lg:py-20">
        <div className="mx-auto flex max-w-[1280px] flex-col items-center gap-6">
          ...
          <p className="max-w-[800px] text-base text-white/90 sm:text-lg">
            Empowering localized darshans, state level matrimonial services, local bhajan
            sandhya bookings, and relief works through structured regional chapters across
            India.
          </p>
        </div>
      </section>
          ...
          <div className="flex flex-1 flex-col gap-6">
            <div className="flex flex-col gap-2">
              ...
              <p className="text-sm text-[#595656]">
                Click on any state chapter to review active districts, registered temples, and
                localized seva statistics.
              </p>
            </div>
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              {STATE_CHAPTERS.map((state) => (
                ...
                >
                  <h3 className="font-serif text-[22px] font-bold text-maroon">{state.name}</h3>
          ...
          <div className="flex w-full flex-col gap-6 lg:w-[360px] lg:shrink-0">
            <div className="flex flex-col gap-5 rounded-2xl bg-maroon p-7">
              ...
              <p className="text-[13px] leading-5 text-white/80">
                Bridging devotion across 15+ states with active local committees managing
                darshan operations, pilgrim food kitchens, and state chapter support.
              </p>
            </div>
