        ...
        <div className="mx-auto flex max-w-[1280px] flex-col items-center gap-10 lg:flex-row lg:items-center">
          ...
          <div className="flex flex-1 flex-col items-center gap-6 text-center lg:items-start lg:text-left">
            ...
            <p className="max-w-2xl text-base leading-[26px] text-white/80">
              A pillar of administrative ethics and community welfare, Smt. Sunita Devi Ji
              governs the traditional family trusts dedicated to Khatu temple operations, women
              empowerment, and senior care homes.
            </p>
          ...
          <div className="flex flex-1 flex-col gap-10">
            <div className="flex flex-col gap-5 rounded-[20px] border border-[rgba(212,175,55,0.25)] bg-white p-8 sm:p-10">
              <p className="font-serif text-3xl font-bold leading-tight text-maroon sm:text-4xl">
                &ldquo;Real empowerment means enabling our daughters and protecting our
                elders.&rdquo;
              </p>
              <p className="text-base leading-[26px] text-[#595656]">
                &ldquo;The strength of Shyam Jagat lies in the self-reliance we can generate for
                the most vulnerable. Through active skills education and transparent donor
                support, we aim to expand our women cooperatives and elder care networks across
                all districts.&rdquo;
              </p>
            </div>
