            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-4">
                {MILESTONES.map((milestone) => (
                  <div
                    key={milestone.title}
                    className="flex flex-col gap-3 rounded-xl border border-[#e5e7eb] bg-white p-5 sm:flex-row sm:gap-4"
                  >
                    <p className="w-[120px] shrink-0 text-sm font-bold text-primary">
                      {milestone.year}
                    </p>
                    <div className="flex flex-1 flex-col gap-1.5">
                      <p className="text-base font-semibold text-[#3e1815]">{milestone.title}</p>
                      <p className="text-sm leading-5 text-[#595656]">{milestone.desc}</p>
                    </div>
                  </div>
                ))}
              </div>
