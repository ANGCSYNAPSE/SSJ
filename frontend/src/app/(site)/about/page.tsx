...
const features = [
  {
    ...
    desc: "Register temples, manage profiles, update schedules, and showcase offerings to thousands of devotees online.",
  },
  {
    title: "Artist Registration & Slot Booking",
    desc: "Bhajan singers, katha speakers, and performers can register, set availability, and get booked for events seamlessly.",
  },
  {
  ...
  },
  {
    ...
    desc: "Enable transparent, secure donations to temples, causes, and relief initiatives with campaign tracking.",
  },
  {
    title: "Spiritual Content",
    desc: "Access a rich library of bhajans, kathas, articles, and devotional videos curated for every seeker.",
  },
  {
