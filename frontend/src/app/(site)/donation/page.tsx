...
export default function DonationPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    alert("Thank you for your generosity! Jai Shree Shyam.");
  };

  return (
    <>
      {/* HERO */}
      <section className="relative -mt-[100px] flex flex-col overflow-hidden pt-[100px]">
        ...
        <div className="mx-auto flex max-w-[1440px] flex-col gap-16 lg:flex-row">
          ...
          >
            ...
            <div className="flex flex-col gap-3">
              <button
                type="submit"
                className="rounded-2xl bg-gradient-to-r from-[#e87722] to-[#d16206] py-4 text-lg font-semibold text-white transition-opacity hover:opacity-90"
              >
                Donate Securely →
              </button>
