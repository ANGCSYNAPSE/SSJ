        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-10">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-3xl lg:text-4xl font-bold text-[#583939] mb-1">25,000+</p>
              <p className="text-sm lg:text-base text-[#666]">Community Members</p>
            </div>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-3xl lg:text-4xl font-bold text-[#583939] mb-1">₹1.8 Cr+</p>
              <p className="text-sm lg:text-base text-[#666]">Donations Raised</p>
            </div>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-3xl lg:text-4xl font-bold text-[#583939] mb-1">4,50,000+</p>
              <p className="text-sm lg:text-base text-[#666]">Meals Served</p>
            </div>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-3xl lg:text-4xl font-bold text-[#583939] mb-1">850+</p>
              <p className="text-sm lg:text-base text-[#666]">Students Supported</p>
            </div>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-3xl lg:text-4xl font-bold text-[#583939] mb-1">120+</p>
              <p className="text-sm lg:text-base text-[#666]">Families Assisted</p>
            </div>
          </div>
        </div>
      </section>
