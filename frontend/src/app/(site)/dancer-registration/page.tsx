...
const danceStyles = ["Kathak", "Bharatanatyam", "Odissi", "Kuchipudi", "Garba/Dandiya", "Folk Dance", "Contemporary Devotional", "Other"];
      ...
      <section className="relative flex items-center justify-center overflow-hidden px-6 py-16 lg:px-20 lg:py-20">
        ...
        <div className="relative flex flex-col items-center gap-6 text-center">
          ...
          <p className="max-w-[800px] text-base leading-7 text-cream sm:text-lg">
            Join Shyam Jagat&apos;s growing community of devotional dancers. Share
            your classical and devotional dance performances at spiritual
            events, cultural programs, and sacred gatherings across India.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto flex max-w-[1224px] flex-col gap-12">
          <div className="flex flex-col items-center gap-4 text-center">
            ...
            <p className="max-w-[760px] text-base leading-7 text-[#595656] sm:text-lg">
              ...
              art and connect you with global devotees.
            </p>
          </div>
