...
export default function DancerRegistrationPage() {
  ...
  const danceStyles = [
    "Kathak", "Bharatanatyam", "Odissi", "Kuchipudi",
    "Garba/Dandiya", "Folk Dance", "Contemporary Devotional", "Other",
  ];
  ...
  const [secondaryDanceStyle, setSecondaryDanceStyle] = useState("Select Secondary Dance Style");
  ...
  const formik = useFormik<Partial<ArtistRegistrationFormData>>({
    ...
    onSubmit: async (values) => {
      ...
      alert("Dancer registration submitted successfully!");
    },
  });
    ...
    <>
      ...
      <section className="relative flex items-center justify-center overflow-hidden px-6 py-16 lg:px-20 lg:py-20">
        ...
        <div className="relative flex flex-col items-center gap-6 text-center">
          ...
          <p className="max-w-[800px] text-base leading-7 text-cream sm:text-lg">
            {"Join Shyam Jagat's growing community of devotional dancers. Share your classical and devotional dance performances at spiritual events, cultural programs, and sacred gatherings across India."}
          </p>
        </div>
      </section>
      ...
      <form onSubmit={formik.handleSubmit} className="bg-cream px-6 py-16 lg:px-20 lg:py-20">
        <div className="mx-auto flex max-w-[1280px] flex-col gap-8">
          ...
          {/* Your Dance & Expertise */}
          <Card title={"Your Dance & Expertise"}>
            <div className="flex flex-col gap-6">
              <div className="grid gap-6 sm:grid-cols-2">
                <div className="flex flex-col gap-2">
                  <FieldLabel label={"Primary Dance Style"} required />
                  <Select
                    options={danceStyles}
                    value={formik.values.artistType ?? danceStyles[0]}
                ...
                <div className="flex flex-col gap-2">
                  <FieldLabel label={"Secondary Dance Style (Optional)"} />
                  <Select
                    options={["Select Secondary Dance Style", ...danceStyles]}
                    value={secondaryDanceStyle}
                    onChange={setSecondaryDanceStyle}
                  />
                </div>
              </div>
              <div className="grid gap-6 sm:grid-cols-2">
                ...
                <div className="flex flex-col gap-2">
                  <FieldLabel label={"Guru / Dance Academy Name (Optional)"} />
                  <input
                    type="text"
              ...
              <div className="flex flex-col gap-2">
                <FieldLabel label={"Brief Bio / About Your Dance"} required />
                <textarea
                  placeholder={"Tell us about your journey as a dancer, your training, and what inspires your devotional performances..."}
              ...
              <div className="flex flex-col items-center justify-center gap-4 rounded-xl border-2 border-dashed border-[rgba(212,175,55,0.25)] bg-cream-light p-10 text-center">
                ...
                <div className="flex flex-col items-center gap-1">
                  <p className="text-base font-semibold text-maroon">
                    {"Drag & drop your performance photos or videos here"}
                  </p>
        ...
        <div className="mx-auto flex max-w-[1224px] flex-col gap-12">
          <div className="flex flex-col items-center gap-4 text-center">
            <h2 className="font-serif text-3xl font-bold leading-[1.1] text-maroon sm:text-[48px]">
              {"Why Join Shyam Jagat as a Dancer?"}
            </h2>
            <div className="h-[3px] w-[100px] bg-primary" />
            <p className="max-w-[760px] text-base leading-7 text-[#595656] sm:text-lg">
              {"Devotion meets showcase. Step onto a platform built to honor your sacred art and connect you with global devotees."}
            </p>
          </div>
